...
const styles = StyleSheet.create({
  ...
  text: { color: '#c5d4de', lineHeight: 20 },
  ...
  uploadCard: {
    ...
    borderWidth: 1,
    borderColor: 'rgba(239,131,84,0.22)',
  },
  uploadTitle: {
    color: '#ffd6c2',
    fontWeight: '800',
  ...
  primaryButtonLabel: { color: '#08131d', fontWeight: '900' },
  secondaryButton: {
    flex: 1,
    alignItems: 'center',
    borderRadius: 18,
  ...
  secondaryButtonLabel: { color: '#f8f2ea', fontWeight: '800', fontSize: 12 },
  ...
  toggleLabel: { color: '#f8f2ea', fontWeight: '700' },
  toggleValue: { color: '#ffd6c2', fontWeight: '800' },
  accountRow: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
