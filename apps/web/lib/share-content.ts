...
export function getWebSharedContentPath(contentType: SharedContentType, contentId: string) {
  switch (contentType) {
...
export function buildWebSharedContentUrl(contentType: SharedContentType, contentId: string) {
  return `${getPublicAppBaseUrl()}${getWebSharedContentPath(contentType, contentId)}`;
}
